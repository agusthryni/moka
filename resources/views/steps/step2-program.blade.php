            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group"> 
                        ...
                        <input type="number" class="form-control persen-kinerja" name="persen_kinerja_program[]" step="0.01" readonly placeholder="Akan dihitung otomatis">
                    </div>
                </div>
            </div>
            {{-- 2 - PROGRAM KEUANGAN --}}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group"> 
                        ...
                        <input type="number" class="form-control persen-keuangan" name="persen_keuangan_program[]" step="0.01" readonly placeholder="Akan dihitung otomatis">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group"> 
